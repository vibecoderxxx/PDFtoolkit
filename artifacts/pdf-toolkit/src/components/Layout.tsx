        ...
        <div className="container mx-auto px-4 h-16 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Show when="signed-out">
              <Link
                href="/sign-in"
                className="text-sm font-medium text-primary-foreground bg-primary hover:bg-primary/90 px-5 py-2 rounded-full border border-primary/50 transition-colors"
